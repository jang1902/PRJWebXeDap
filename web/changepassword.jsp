<%-- 
    ...
    Created on : Nov 2, 2022, 2:31:36 PM
    Author     : ASUS
--%>
    ...
    <div class="content1__signup">
        <div class="container__content__signup">
            <div class="text_signup text-uppercase">
                <span class="text_transform" style="color: black">CHANGE PASSWORD</span>
            </div>
            <!-- Form -->
                ...
                <div class="row1">
                    <div style="margin-top: 20px;">
                        <form action="changepass" method="post" >
                            ...
                            <input readonly class="position_input input_form" type="text" placeholder="Username" name="user" value="${sessionScope.user}">
                        <input class="position_input input_form" type="password" placeholder="Old Password" name="oldpass">
                        
                        <input class="position_input input_form" type="password" placeholder="New Password" name="newpass">
                       <input class="position_input input_form" type="password" placeholder="Re-New Password" name="newpass2">
                        
                        <input class="btn_signup text-uppercase" value="CHANGE" type="submit" style="height: 50%" >
                        </form>
