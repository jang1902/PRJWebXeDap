<%-- 
    Document   : searchmanage.jsp
    Created on : Nov 2, 2022, 6:44:10 PM
    Author     : ASUS
--%>
...
<body>
            ...
            <div id="navbar" class=" justify-content-between">
                ...
                <ul class="head_link flex no_margin justify-content-between">
                    <li class="text-uppercase center_text text_possition">
                            <a class="no_underline cool-link" href="manage" style="color: black">Manage</a>
                        </li>
                </ul>
                <!-- Log in__Cart -->
    ...
    <!-- Content -->
        ...
        <div class="container_cart">
            ...
            <br/>
            <a class="style__" href="add"><i title="ADD A PRODUCT" class="fa-solid fa-circle-plus"></i> ADD NEW PRODUCT</a>
            ...
            <table border="1px" style="border-collapse: collapse" >
                    <tr>
                        ...
                        <th style="width: 200px">DESCRIBE</th>
                    ...
                    <c:forEach items="${requestScope.listp}" var="l">
                        <tr>
                            ...
                            <td > 
                                <img src="${l.images}" style="width: 217px;height: 178px">
                                ${l.pname}
                            </td>
                            <td style="text-align: center">${l.price}</td>
                            <td style="text-align: center">${l.quantity}</td>
                            <td style="text-align: center">${l.describe}</td>
